...
### Enterprise Design Language
   ...
   1. Sabre Spark Enterprise Design Language
      ...
      <Image  img={require('../static/img/portfolio/spark-edl-screenshot.webp')} />
...
### Ecommerce
  ...
  5. Shukran
    ...
    <Image  img={require('../static/img/portfolio/Shukran.png')} />
...
### Marketing
  ...
  8. Cisco Webex Sales Pages
    ...
    <Image  img={require('../static/img/portfolio/cisco-webex.png')} />
...
### Personal
  ...
  10. Bookstoc - Unconventional books cataloging app
  ...
  <Image  img={require('../static/img/portfolio/bookstoc.png')} />
  ...
  <Image  img={require('../static/img/portfolio/dhbalaji-website.png')} />

  Tech stack - docusarus, vercel, css, nodeJS, google domains

  [dhbalaji.dev website](www.dhbalaji.dev)
...
### Not For Profits
  ...
  <Image  img={require('../static/img/portfolio/satpraje.png')} />

  Tech Stack: Wordpress

  [Satpraje Website](https://satpraje.org/)

   13. Mann Cottage Industry Products Catalog

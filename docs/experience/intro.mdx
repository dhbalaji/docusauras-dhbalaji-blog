...
import croImg from "../../static/img/2025/cro.png";

> TLDR: I lead frontend architecture and engineering across multiple AI-driven product teams, with a primary focus on building scalable, production-grade React applications and enabling AI-assisted development workflows. My role combines hands-on engineering, system design, and AI adoption leadership, with minimal people management and full ownership of technical quality, delivery velocity, and long-term maintainability.

## AI Enablement
- Designed and implemented an MCP server for the Spark React library to enable AI-driven design-to-code workflows.
- Integrated Figma-to-code translation using modular, EDL-compliant components.
- Deployed MCP infrastructure on Google run for organization-wide usage.
- Built AI assistant RAG interfaces similar to chatgpt interface inside products.
- Defined Copilot instructions and slash commands for consistent AI usage.
- Introduced AI-augmented code reviews and validation workflows.

Result: Higher developer throughput, improved design consistency, and AI agents at work reducing dependency on human team members. Enhanced developer experience.

## Core Responsibilities

- Led frontend architecture for CRO, an enterprise AI product, from inception to large-scale deployment.
- Designed and implemented a future-proof React stack aligned with Sabre’s internal ecosystem and compliance constraints.
- Balanced in-house development and strategic vendor tooling to optimize delivery speed and platform stability.
- Built proof-of-concepts and production-ready AI integrations for frontend products with MCP servers.
- Drove organization-wide AI adoption for UI development, testing, and code review.
- Provided technical leadership across cross-functional teams including frontend, backend, cloud, UX, automation, and program management.
- Acted as a technical connector across teams by staying aligned with parallel product initiatives.

## Platform Leadership

- Conceptualized and built frontend platforms from a clean slate.
- Evaluated and standardized core tooling for portfolio of frontend products:
   - React, TanStack Query, Zustand
   - Ag Grids, High charts
   - Vitest, Playwright
   - MCP Servers, RAG clients
   - GitHub Copilot instructions / custom AI Agents
- Established scalable folder structures, dependency governance, and coding standards.
- Selected enterprise-grade charting and grid libraries under perpetual licenses to reduce time-to-market and operational risk.

Result: Faster delivery cycles, predictable scalability, and reduced long-term maintenance overhead.
...
<img src={croImg} alt="Revenue Optimizer" />
...
5. Established scalable folder structures, dependency governance, and coding standards.
...
Result: Predictable scalability, faster delivery, and reduced maintenance overhead.
...
2.  Sabre Spark Enterprise Design Language
    ...
    Result: Unified UI standards and faster onboarding.

    Led frontend enablement for an enterprise-wide rebranding initiative. Partnered with multiple portfolio teams to implement design and structural changes. Created reference GitHub pull requests as living documentation. Defined migration patterns for logos, assets, and branding guidelines. Provided hands-on support to ensure smooth adoption across products.

    Result: Consistent brand rollout with minimal disruption to delivery timelines.

    <img
      src={require("../../static/img/portfolio/spark-edl-screenshot.webp")}
      alt="Sabre Spark EDL screenshot"
    />
...
3. Sabre Sonic Inventory GUI
   ...
   <img src={require("../../static/img/portfolio/ssi-gui-inv.webp")} alt="Sabre Sonic Inventory GUI" />
...
4. Landmark brands mdot webapps
   ...
   <img src={require("../../static/img/portfolio/mob-website.webp")} alt="Landmark brands mdot webapps" />
...
<img src={require("../../static/img/portfolio/max-fashion.webp")} alt="Max Fashion website" />
...
6. Shukran
   ...
   <img src={require("../../static/img/portfolio/shukran.webp")} alt="Shukran" />
...
7. Chrome river
   ...
   <img src={require("../../static/img/portfolio/chrome-river.webp")} alt="Chrome River" />
...
8. Vista Real estate
   ...
   <img src={require("../../static/img/portfolio/vesta.webp")} alt="Vista Real estate" />
...
9. Cisco Webex Sales Pages
   ...
   <img src={require("../../static/img/portfolio/cisco-webex.webp")} alt="Cisco Webex Sales Pages" />
...
10. Impartus Video Lectures
   ...
   <img src={require("../../static/img/portfolio/impartus.webp")} alt="Impartus Video Lectures" />
...
<img src={require("../../static/img/portfolio/bookstoc.webp")} alt="Bookstoc" />
...
<img src={require("../../static/img/portfolio/dhbalaji-website.webp")} alt="dhbalaji.dev website" />
...
<img src={require("../../static/img/portfolio/satpraje.webp")} alt="Satpraje" />
